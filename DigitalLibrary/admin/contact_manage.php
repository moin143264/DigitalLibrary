...
if (mysqli_num_rows($result)>0) {
    echo "   <h1 class='text-center'>Manage Contact  <i class='fa-solid fa-bottom-to-bracket' aria-hidden='true'></i></h1>
    <div
...
";
    ...
    echo "No Request".mysqli_error($conn);
}
