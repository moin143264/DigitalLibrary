...
footer{
  ...
  >
    ...
    <hr class='border border-light border-5' >
    <main style="background-image: url(../uploads/cardb.jpg)">
      <div class="container-fluid my-5 p-5 border border-5 border-success"  style='max-width:600px;border-radius:50px' >
