...
if (mysqli_num_rows($result)>0) {
    echo "<h1 class='text-center'>Manage Dashboard  <i class='fa-solid fa-bottom-to-bracket' aria-hidden='true'></i></h1>
    <div
        ...
        <tr class=''>
            ...
            <td scope='row'>
                ...
                <a
                    ...
                    href='delete_dash.php?id={$rows['id']}'
                    role='button'
                    >Delete</a
                >
