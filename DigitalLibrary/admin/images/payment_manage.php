...
if (mysqli_num_rows($result)>0) {
    echo "
    <h1 class='text-center'>Manage Payments  <i class='fa-solid fa-bottom-to-bracket' aria-hidden='true'></i></h1>
    <div
    ...
    while ($rows = mysqli_fetch_assoc($result)) {
        ...
        <tr class=''>
            ...
            <td>{$rows['user_id']}</td>
            <td>{$rows['pdf_id']}</td>
            <td scope='row'>{$rows['contact']}</td>
            <td>{$rows['payment_id']}</td>
            <td>{$rows['purchase_time']}</td>
            <td>{$rows['date_one_month_later']}</td>
            <td>{$rows['cost']}</td>
            <td scope='row'>
