 ...
 include "conn.php";
 $id=$_GET["id"];
 $sql="select * from dash where id='$id';";
      ...
      <div class="container-fluid my5 p-5 border border-5 border-dark" style='max-width:600px;border-radius:50px'>
        <div class="row justify-content-center align-items-center g-2">
          ...
          <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
            ...
            <form action="Update_dash.php" method="post" enctype="multipart/form-data">
                <div class="mb-3">
...
<div class="mb-3">
  ...
  <input
    ...
    value="<?php 
                        ...
                        ?>"
  />
  <p class='text-capitalize'>current image=><?php echo "{$row['image']}"; ?></p>
</div>
<div class="mb-3">
