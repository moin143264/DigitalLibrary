      ...
      <nav class="navbar navbar-expand-sm">
        ...
        <form
          ...
          >
            ...
            >
              <i
                class="fa-solid fa-magnifying-glass fa-flip fa-md search-icon"
              ></i>
            </button>
          </form>
          <button
...
if (mysqli_num_rows($result)>0) {
    ...
    while ($rows = mysqli_fetch_assoc($result)) {
        ...
        <img class='card-img-top p-3  img-fluid ' src='dash_image/{$rows['image']}' alt='Title' style=height:250px;width:500px;border-radius:200px;background-image:transparent'  />

            <div class='card-body'>
                <h4 class='card-title'>{$rows['name']}</h4>
                
                <a name='' id='' class='btn btn-primary larger-btn' href='{$rows['link']}' role='button'>Manage</a>
            </div>
        </div>
        </div>";
    }
