...
footer{
 ...
 <div class="text-capitalize">
    <div
        class="container mt-5 mb-2 -5 border border-white border-5 text-center" style="max-width:500px;border-radius:10px;font-family:sans-sarif;font-weight:80"
    >
        Invalid Credentials<br>
        <a href='Main_Login.html' class="text-center" style='color:green;font-family:fantasy;text-decoration:none'>Try Again</a>
        
    </div>
    
 </div>
      <div class="container text-center">
        <button style="border-color: seashell; border-radius: 15px">
          <a
            href="Main.php"
            style="
              border-radius: 15px;
