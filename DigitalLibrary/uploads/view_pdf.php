...
<body  class="ocean-breeze">
    ...
    <footer class="text-center text-sm-start text-dark mt-auto ">
                    ...
                    <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                        ...
                        <!-- Popup Modal -->
                                                ...
                                                <div class="modal fade" id="hell" tabindex="-1" aria-labelledby="popupModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content" style="background: #d6cdcd">
                                                            ...
                                                            <div class="modal-body">
                                                                <p>DigitalLibrary is a place where you can find a variety of digital resources. Our mission is to provide easy access to high-quality content. Feel free to contact us for any queries or support.</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="text-center p-4" style="background-color: #d6cdcd">
                                © 2024 DigitalLibrary:
                                <a class="text-reset fw-bold" href="https://digitallibrarymanagement.kesug.com">www.Digitallibrary.com</a>
                            </div>
                            <!-- Copyright -->
                        </footer>
